...
public abstract class SideMenuBaseFormTEAM extends Form {
 ...
 Image i=null;
        ...
        getToolbar().addMaterialCommandToSideMenu(" My Tasks", FontImage.MATERIAL_TRENDING_UP,  e -> showtasks(res));
        getToolbar().addMaterialCommandToSideMenu("  ", FontImage.MATERIAL_ACCESS_TIME,  e -> showtasks(res));
