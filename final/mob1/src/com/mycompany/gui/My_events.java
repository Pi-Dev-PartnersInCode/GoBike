 ...
 * @author Malek
 */
public class My_events  extends SideMenuBaseFormSM {
    ...
    public My_events(Resources res,String username, int id,String img)  {
        super(BoxLayout.y());
        ...
        menuButton.addActionListener(e -> getToolbar().openSideMenu());
         ArrayList<event> sprints = srv.my_events(id);
      ...
      Container remainingTasks = BoxLayout.encloseY(
        ...
        for (int i=0;i<k;i++){
        addButtonBottom(res,arrowDown, sprints.get(i).getNomEvent(),sprints.get(i).getDateEvent(), 
                0x5ae29d, true,i,username,id,sprints.get(i).getId(),img);
        }
