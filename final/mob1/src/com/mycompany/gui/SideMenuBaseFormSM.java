...
public abstract class SideMenuBaseFormSM extends Form{
 ...
 System.err.println("");
     ...
     //   Image profilePic = i;
        ...
        getToolbar().addMaterialCommandToSideMenu("  Les events", FontImage.MATERIAL_TRENDING_UP,  e -> showOtherForm1(res));
        getToolbar().addMaterialCommandToSideMenu(" My events ", FontImage.MATERIAL_ACCESS_TIME,  e ->showForm2(res));
